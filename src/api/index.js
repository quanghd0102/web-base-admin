...
export const postAPI = requestWrapper('POST');
export const putAPI = requestWrapper('PUT');
export const patchAPI = requestWrapper('PATCH');
export const delAPI = requestWrapper('DELETE');
